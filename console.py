#!/usr/bin/python3
"""
File defines the console class which will
serve as the entry point of the project
"""
...
class HBNBCommand(Cmd):
    """
    Console based driver of the AirBnb Clone
    Interactions with the system is done via
    this class"""
